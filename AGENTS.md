...
- Web chrome and fallback labels should use [apps/web/src/i18n.tsx](REPO_ROOT/apps/web/src/i18n.tsx).
...
- Package and extension text should use the shared locale helpers under [extensions/shared/locale.ts](REPO_ROOT/extensions/shared/locale.ts) instead of ad hoc string branching.
